...
public class DestaquesFragment extends Fragment {
    ...
    View view;
    SwipeRefreshLayout swipeRefreshDestaques;
...
//        swipeRefreshDestaques = (SwipeRefreshLayout) view.findViewById(R.id.swipe_destaques);
//        swipeRefreshDestaques.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
//            @Override
...
//                    @Override
//                    public void run() {
//                        swipeRefreshDestaques.setRefreshing(false);
//                    }
//                }, 4000);
//            }
//        });
        ...
        view = inflater.inflate(R.layout.fragment_destaques, container, false);
        return view;
        ...
        call.enqueue(new Callback<FestDeliveryRepo>() {
            ...
            public void onResponse(Call<FestDeliveryRepo> call, Response<FestDeliveryRepo> response) {
                ...
                if (code == 200) {
                    ...
                    List<Produto> produto = filtrarProdutosPorDestaque(response.body().data);
